...
const About = () => {
    return (
        ...
        <div
            name='acerca de'
            className='w-full h-screen bg-gradient-to-b from-gray-800 to-black text-white flex flex-wrap'
        >
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
                ...
                <br />
                <p className='md:text-xl'>Poco despues se me presento la oportunidad de trabajar en la empresa IDS como desarrollador cobol, donde estuve por seis meses, sin dejar de lado mis desarrollos personales, donde aprendí muchas cosas pero tambien me dí cuenta que lo que en verdad me gustaba era el desarrollo web</p>
                <br />
                <p className='md:text-xl'>
